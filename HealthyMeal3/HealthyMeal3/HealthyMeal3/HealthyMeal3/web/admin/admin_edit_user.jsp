                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" readonly name="email" value="${email}">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="permission" class="form-control" id="exampleSelect1">
                                        <option value="True" ${roleid ? 'selected' : ''}>Cho phép</option>
                                        <option value="False" ${!roleid ? 'selected' : ''}>Hủy bỏ</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-12">
