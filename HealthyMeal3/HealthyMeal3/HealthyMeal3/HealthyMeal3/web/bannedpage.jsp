<%-- 
    Document   : 404page
    Created on : Jul 3, 2024, 1:52:10 PM
    Author     : NC
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./asset/404page.css" />
    </head>
    <body>
        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    <h1 class="heading">Banned</h1>
                    <p class="subheading">Looks like the page you were Banned hehe .</p>
                </div>
            </div>
