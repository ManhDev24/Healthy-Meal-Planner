                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="widget-small info coloured-icon"><i class='icon bx bxs-data fa-3x'></i>
                                <div class="info">
                                    ...
                                    <p><b>${requestScope.TOTALDISHES} món ăn</b></p>
                                    <p class="info-tong">Tổng số món ăn được quản lý.</p>
                                </div>
                            </div>
                        </div>
                        <!-- col-6 -->
                        ...
                        <div class="col-md-6">
                            <div class="widget-small danger coloured-icon"><i class='icon bx bxs-error-alt fa-3x'></i>
                                <div class="info">
                                    <h4>Sắp hết nguyên liệu </h4>
                                    <p><b>${requestScope.DISHESLOW} món</b></p>
                            ...
                            <div class="tile">
                                ...
                                <div>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <c:forEach items="${LAST_RECENT_ORDER}" var="b">
                                                <tr>
                                                    <td>${b.id}</td>
                                                    <td>${b.account.fullname}</td> <!-- Accessing account's fullname -->
                                                    <td>(+84) ${b.account.phone}</td> <!-- Accessing account's phone -->
                                                    <td>${b.account.address}</td> <!-- Accessing account's address -->
                                                    <td>${b.order_date}</td>
                                                    <td>${b.totalPrice}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a style="color: rgb(245 157 57); background-color: rgb(251 226 197); padding: 5px; border-radius: 5px;" 
                                                           href="ManageOrder?action=showdetail&bill_id=${b.id}">
